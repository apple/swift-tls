...
struct StreamingInterpolation<P: CharacterPrinter>: StringInterpolationProtocol {
    ...
    mutating func appendInterpolation(
        _ value: @autoclosure () -> StaticString
    ) {
        printer.write(value())
    }
    ...
    mutating func appendInterpolation(
        _ value: @autoclosure () -> some FixedWidthInteger
    ) {
        printer.write(value())
    }
    ...
    mutating func appendInterpolation(_ value: @autoclosure () -> some _Pointer) {
...
struct StreamingMessage<P: CharacterPrinter>: ExpressibleByStringInterpolation {
    ...
    init(stringLiteral value: StaticString) {
        self.interpolation = StreamingInterpolation(literalCapacity: 0, interpolationCount: 0)
        self.interpolation.appendLiteral(value)
    }

    var printer: P { interpolation.printer }

    var interpolation: StreamingInterpolation<P>
}
